# STO - BY FLOURISH — Windows installers

Public downloads only. Source code stays in a private repo.
...
1. Download the Setup `.exe` for the version you need.
2. Close STO if it is already running.
...
Do not clone this repository. It only holds large installer files. Use the Download links above.
